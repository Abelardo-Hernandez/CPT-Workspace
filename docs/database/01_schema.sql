...
CREATE TABLE IF NOT EXISTS kpi_resultados (
    ...
    KEY idx_kpi_resultados_fecha_medicion (fecha_medicion),
    KEY idx_kpi_resultados_fecha_registro (fecha_registro),
    KEY idx_kpi_resultados_proyecto_fecha (proyecto_id, fecha_medicion, fecha_registro),
    KEY idx_kpi_resultados_reunion_fecha (reunion_id, fecha_medicion, fecha_registro),
